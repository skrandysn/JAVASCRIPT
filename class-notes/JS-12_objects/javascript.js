...
//? Write
worker.age += 1; //*OBJE İÇERİSİNDE Kİ AGE DEĞİŞTİRDİK
console.log({ worker });
...
//! Deep Copy
let deepCopyOfWorker = JSON.parse(JSON.stringify(worker)); //? Deep Copy //* json.string  burada worker objesini string ifadeye çevirdi
